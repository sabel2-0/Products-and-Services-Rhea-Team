...
using System.Text.Json; // NEW: Added missing Using Directive
...
namespace MyAspNetApp.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetProductById(int id)
        {
            try
            {
                ...
                if (dbProduct != null)
                {
                    ...
                    // We now store the mapped product in a variable so we can inject the size guide
                    var mappedProduct = MapDbProduct(dbProduct, colorImgs, variants, reviewStats, mappedReviews);

                    // NEW: Missing Size Guide Mapping
        ...
        // NEW: Missing Size Guide Payload Class & Parsing Helpers
